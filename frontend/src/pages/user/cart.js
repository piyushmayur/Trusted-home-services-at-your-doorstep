...
const Cart = ()=>{
   ...
   return(
        <div>
          ...
          {/* //<div style="background-image: url(https://thumbs.dreamstime.com/z/online-booking-flat-illustration-calendar-day-reservation-marked-white-background-ideal-41529348.jpg)"></div>
